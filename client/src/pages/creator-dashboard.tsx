...
export default function CreatorDashboard({ inTabView = false }: CreatorDashboardProps) {
          ...
          {!inTabView && (
            <>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
                Creator Dashboard
                <Badge className="ml-3 bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-200" variant="outline">
      ...
      <Tabs defaultValue="projects" className="w-full">
            ...
            <Card>
              <CardContent className="p-10 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md">
                  Start creating your first project to find collaborators and bring your ideas to life.
                </p>
        ...
        <TabsContent value="applications">
          {!isLoading && filteredProjects.length > 0 ? (
            <>
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-2">Project Applications</h3>
                <p className="text-muted-foreground">
                  View and manage applications for your projects. Accept or reject applications from potential collaborators.
                </p>
              </div>
              
              <Tabs defaultValue={filteredProjects[0]?.id.toString()} className="w-full">
            ...
            <Card>
              <CardContent className="p-10 flex flex-col items-center justify-center text-center">
                <h3 className="text-xl font-semibold mb-2">No projects or applications</h3>
                <p className="text-gray-500 dark:text-gray-400 max-w-md mb-6">
                  You need to create a project first before you can receive applications.
                </p>
                <Button onClick={() => setOpenDialog(true)}>
                  <Plus className="h-4 w-4 mr-2" />
                  Create Project
