                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-2xl font-semibold">
                        {userData?.projects?.filter(p => p.creatorId === userData.user.id).length || 0}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Projects Joined</p>
                      <p className="text-2xl font-semibold">
                        {userData?.projects?.filter(p => p.creatorId !== userData.user.id).length || 0}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-2xl font-semibold">{userData?.applications?.length || 0}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
