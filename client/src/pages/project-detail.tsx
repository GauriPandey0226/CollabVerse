          ...
          <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-1">
                {project.timeline ? `Timeline: ${project.timeline}` : "No timeline specified"}
              </p>
            </div>
          ...
          {isTeamMember || isCreator ? (
            <Tabs defaultValue="overview" className="w-full">
              ...
              <TabsContent value="overview">
                <ProjectDetails project={project} teamMembers={teamMembers} isCreator={isCreator} />
              </TabsContent>
            ...
            <ProjectDetails project={project} teamMembers={teamMembers} isCreator={isCreator} isPublicView />
          )}
        </div>
      </main>
      <Footer />
      ...
      <Dialog open={showApplyDialog} onOpenChange={setShowApplyDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Tell the project creator why you'd like to join and what skills you can contribute.
            </DialogDescription>
          </DialogHeader>
