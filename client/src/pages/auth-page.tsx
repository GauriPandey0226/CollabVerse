            ...
            >
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Join our collaborative platform to connect with innovators and creators worldwide.
                  Whether you have a project idea or want to contribute your skills, CollabVerse helps
